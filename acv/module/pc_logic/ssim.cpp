...
double calcSSIM(const cv::Mat& src1, const cv::Mat& src2, cv::Mat& ssim_map, cv::Mat& mask, int channel, int method,const double K1, const double K2,	const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
...
double calcDSSIM(cv::Mat& src1, cv::Mat& src2, cv::Mat& ssim_map, cv::Mat& mask, int channel, int method, const double K1, const double K2,	const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
	if(ssim_map.empty())ssim_map.create(src1.size(),CV_8U);
...
double calcDSSIMBB(cv::Mat& src1, cv::Mat& src2, cv::Mat& ssim_map, int channel, int method, int boundx,int boundy,const double K1, const double K2,	const int L, const int downsamplewidth, const int gaussian_window, const double gaussian_sigma)
{
	if(ssim_map.empty())ssim_map.create(src1.size(),CV_8U);
